...
EMAIL_DICT: dict[str, dict[str, str]] = {
    ...
    # ── Bandeau organisation (SaaS multi-organisation) ──────────────────
    "inspection_realisee_par": {"fr": "Inspection réalisée par", "en": "Inspection performed by"},

    # ── Sujets courts (préfixés du nom de l'organisation) ───────────────
    "reparations_sujet_court": {"fr": "Réparations requises avant certificat", "en": "Repairs required before certificate"},
    "certificat_dispo_sujet_court": {
        "fr": "Votre rapport et certificat sont disponibles",
        "en": "Your report and certificate are available",
    },
    "certificat_extincteur_sujet_court": {
    ...
    "direct_intro_suite": {
        "fr": "Le rapport complet et le certificat de chaque inspection sont joints à ce courriel en PDF — aucune connexion n'est requise pour les consulter.",
        "en": "The full report and certificate for each inspection are attached to this email as a PDF — no login is required to view them.",
    },
    "direct_pieces_jointes_suffixe": {
        "fr": "pièce(s) jointe(s) (rapport + certificat pour chaque inspection).",
        "en": "attachment(s) (report + certificate for each inspection).",
    },
